...
\usepackage{tocloft}
\cftsetindents{chapter}{-0.5em}{2em} % primul e pt distanta cifrei fata de margine, a doua e pt distanta dintre cifra si litera
...
\include{3-ecosistemulGCP}
\include{4-implementare}
\include{5-concluzii}

\begin{appendix}
\include{6-requestExample}
\include{7-exampleConv}
\end{appendix}
